...
Or select event manually.',
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            array(
                'key' => 'field_69036e43cf912',
                'label' => 'Tags - Ad matching',
                'name' => 'tags_ad_matching',
                'aria-label' => '',
                'type' => 'repeater',
                'instructions' => '',
                'required' => 0,
                ...
                'sub_fields' => array(
                    ...
                    array(
                        'key' => 'field_69037009cf915',
                        'label' => 'After paragraph',
                        'name' => 'after_paragraph',
                        'type' => 'number',
                        'required' => 1,
                        'default_value' => 3,
                        'min' => '',
