...
//        'enqueue_style'     => get_template_directory_uri() . '/dist/css/blocks/sidebar-editors-picks-section.min.css',  - Changed to critical CSS
        'example'  	=> array(
            'attributes' => array(
                'mode' => 'preview',
                'data' => array(
...
//        'enqueue_style'     => get_template_directory_uri() . '/dist/css/blocks/news-with-hero.min.css', - Changed to critical CSS
        'example'  	=> array(
            'attributes' => array(
                'mode' => 'preview',
                'data' => array(
...
//        'enqueue_style'     => get_template_directory_uri() . '/dist/css/blocks/categories-section-block.min.css', - Changed to critical CSS
        'example'  	=> array(
            'attributes' => array(
                'mode' => 'preview',
                'data' => array(
